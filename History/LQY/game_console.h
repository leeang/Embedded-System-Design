...
/* --------- IO Direction --------- */
#define ADC_DIR(DIR)			WRITE(DDRA, _BV(PA7), DIR)
#define LOW_LED_DIR(DIR)		WRITE(DDRA, _BV(PA6), DIR)
#define UP_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA0), DIR)
#define RT_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA1), DIR)
#define LT_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA2), DIR)
#define DN_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA3), DIR)
#define AA_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA4), DIR)
#define BB_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA5), DIR)
...
#define CSFM_DIR(DIR)			WRITE(DDRB, _BV(PB1), DIR)
#define CSLCD_DIR(DIR)			WRITE(DDRD, _BV(PD3), DIR)
#define RSTLCD_DIR(DIR)			WRITE(DDRD, _BV(PD4), DIR)
#define CDLCD_DIR(DIR)			WRITE(DDRC, _BV(PC1), DIR)
#define HOLDFM_DIR(DIR)			WRITE(DDRD, _BV(PD5), DIR)
#define WPFM_DIR(DIR)			WRITE(DDRD, _BV(PD6), DIR)


/* --------- Outputs --------- */
#define LOW_LED_STATE(STATE)	WRITE(PORTA, _BV(PA6), ~STATE)

#define PWM_STATE(STATE)		WRITE(PORTB, _BV(PB3), STATE)
#define SS_STATE(STATE)			WRITE(PORTB, _BV(PB4), STATE)

#define CSFM_STATE(STATE)		WRITE(PORTB, _BV(PB1), STATE)
#define CSLCD_STATE(STATE)		WRITE(PORTD, _BV(PD3), STATE)
#define RSTLCD_STATE(STATE)		WRITE(PORTD, _BV(PD4), STATE)
#define CDLCD_STATE(STATE)		WRITE(PORTC, _BV(PC1), STATE)
#define HOLDFM_STATE(STATE)		WRITE(PORTD, _BV(PD5), STATE)
#define WPFM_STATE(STATE)		WRITE(PORTD, _BV(PD6), STATE)


/* --------- Inputs --------- */
#define UP_BUTTON		~READ(PINA, _BV(PA0))
#define RT_BUTTON		~READ(PINA, _BV(PA1))
#define LT_BUTTON		~READ(PINA, _BV(PA2))
#define DN_BUTTON		~READ(PINA, _BV(PA3))
#define AA_BUTTON		~READ(PINA, _BV(PA4))
#define BB_BUTTON		~READ(PINA, _BV(PA5))


/* --------- Pull-up --------- */
#define UP_PULL_UP		WRITE(PORTA, _BV(PA0), HIGH)
#define RT_PULL_UP		WRITE(PORTA, _BV(PA1), HIGH)
#define LT_PULL_UP		WRITE(PORTA, _BV(PA2), HIGH)
#define DN_PULL_UP		WRITE(PORTA, _BV(PA3), HIGH)
#define AA_PULL_UP		WRITE(PORTA, _BV(PA4), HIGH)
#define BB_PULL_UP		WRITE(PORTA, _BV(PA5), HIGH)
