...
/* --------- IO Direction --------- */
#define LOW_LED_DIR(DIR)		WRITE(DDRC, _BV(PC1), DIR)
#define UP_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA3), DIR)
#define LT_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA4), DIR)
#define DN_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA2), DIR)
#define RT_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA5), DIR)
#define BB_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA7), DIR)
#define AA_BUTTON_DIR(DIR)		WRITE(DDRA, _BV(PA6), DIR)
...
#define CSLCD_DIR(DIR)			WRITE(DDRB, _BV(PB0), DIR)
#define RSTLCD_DIR(DIR)			WRITE(DDRB, _BV(PB1), DIR)
#define CDLCD_DIR(DIR)			WRITE(DDRB, _BV(PB2), DIR)
#define HOLDFM_DIR(DIR)			WRITE(DDRD, _BV(PD5), DIR)
#define WPFM_DIR(DIR)			WRITE(DDRD, _BV(PD3), DIR)


/* --------- Outputs --------- */
#define LOW_LED_STATE(STATE)	WRITE(PORTC, _BV(PC1), ~STATE)

#define PWM_STATE(STATE)		WRITE(PORTB, _BV(PB3), STATE)

#define CSFM_STATE(STATE)		WRITE(PORTD, _BV(PD4), STATE)
#define CSLCD_STATE(STATE)		WRITE(PORTB, _BV(PB0), STATE)
#define RSTLCD_STATE(STATE)		WRITE(PORTB, _BV(PB1), STATE)
#define CDLCD_STATE(STATE)		WRITE(PORTB, _BV(PB2), STATE)
#define HOLDFM_STATE(STATE)		WRITE(PORTD, _BV(PD5), STATE)
#define WPFM_STATE(STATE)		WRITE(PORTD, _BV(PD3), STATE)


/* --------- Inputs --------- */
#define UP_BUTTON		~READ(PINA, _BV(PA3))
#define LT_BUTTON		~READ(PINA, _BV(PA4))
#define DN_BUTTON		~READ(PINA, _BV(PA2))
#define RT_BUTTON		~READ(PINA, _BV(PA5))
#define BB_BUTTON		~READ(PINA, _BV(PA7))
#define AA_BUTTON		~READ(PINA, _BV(PA6))


/* --------- Pull-up --------- */
#define UP_PULL_UP		WRITE(PORTA, _BV(PA3), HIGH)
#define LT_PULL_UP		WRITE(PORTA, _BV(PA4), HIGH)
#define DN_PULL_UP		WRITE(PORTA, _BV(PA2), HIGH)
#define RT_PULL_UP		WRITE(PORTA, _BV(PA5), HIGH)
#define BB_PULL_UP		WRITE(PORTA, _BV(PA7), HIGH)
#define AA_PULL_UP		WRITE(PORTA, _BV(PA6), HIGH)
